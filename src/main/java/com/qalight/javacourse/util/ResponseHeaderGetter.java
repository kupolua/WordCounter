...
public class ResponseHeaderGetter {
    ...
    public String getTextTypeByHttpHeader(String dataSourceLink) {
        ...
        try {
            ...
            String msg = "It is impossible to determine the type of the document because we can not connect to this link: ";
            LOG.error(msg + dataSourceLink, e);
            throw new IllegalArgumentException(msg + dataSourceLink, e);
        }
        return contentType;
    }
