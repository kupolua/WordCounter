...
public class ViewsConstants {
    ...
    public static final float WIDTH_TABLE_ONE = 2.0f;
    public static final float WIDTH_TABLE_TWO = 1.0f;
    public static final String FONT_ARIAL_BOLD_ITALIC = "fonts/arialbi.ttf";
    public static final String FONT_ARIAL_NORMAL = "fonts/arial.ttf";
    public static final String HEAD_CELL_WORDS_EN = "Words";
    public static final String HEAD_CELL_COUNT_EN = "Count";
    public static final String HEAD_CELL_WORDS_RU = "Слово";
    public static final String HEAD_CELL_COUNT_RU = "Количество";
