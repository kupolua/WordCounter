...
public class WordFilter {
    ...
    private final String WORDS_FOR_FILTER = WORDS_FOR_FILTER_EN + WORDS_FOR_FILTER_RU + WORDS_FOR_FILTER_UA;

    public List<String> removeUnimportantWords(List<String> refinedWords) {

        TextRefiner textRefiner = new TextRefiner();
        List<String> filter = textRefiner.refineText(WORDS_FOR_FILTER);
