...
var dataResponse;
var swichFilter = 0;
function getResponse(dataString) {
    var jqXHR = $.ajax({
        type: "POST",
        url: "./countWords",
        data: dataString,
        ...
        success: function( data, textStatus, jqXHR) {
            ...
            if(data.success){
                ...
                writeTable(dataResponse, swichFilter); //todo remove writeTable(). Use callback
            }
        },
...
function writeTable(unFilteredWords, isFilter) {
    ...
    $("#buttonGetFilterWords").click(function(e){
        ...
        $('#countedWords').hide();
        isFilter = 1;
//        alert("dataResponse = " + dataResponse + "isFilter = " + isFilter)
