...
// todo: change test link (add words)
public class ResultsPresentationFunctionalityTest {
    private static WebDriver driver;

    private final String ELEMENT_DATA_TABLES_LENGTH = "countedWords_length";
    private final String DATA_TABLES_LENGTH_100 = "100";
    ...
    @Test
     public void testShowEntries50() throws Exception {
        ...
        // then
        if (isReady) {
            final String DATA_TABLES_LENGTH_50 = "50";
            new Select(driver.findElement(By.name(ELEMENT_DATA_TABLES_LENGTH))).selectByVisibleText(DATA_TABLES_LENGTH_50);
            final String EXPECTED_SHOW_ENTRIES_50 =
                    "one 4\n" + "ёлка 3\n" + "two 3\n" + "білка 3\n" + "объем 3\n" + "їжак 2\n" + "объём 1\n" + "ученики 1\n" +
                            "і 1\n" + "але 1\n" + "имя 1\n" + "слово 1\n" + "a 1\n" + "но 1\n" + "дом 1\n" + "друг 1\n" + "єнот 1\n" +
                            "время 1\n" + "та 1\n" + "the 1\n" + "человек 1\n" + "народ 1\n" + "r 1\n" + "завет 1\n" + "сказал 1";
            String actualShowEntries = driver.findElement(By.cssSelector(ANCHOR_HTML_PAGE_WITH_WORDS)).getText();
            assertEquals(EXPECTED_SHOW_ENTRIES_50, actualShowEntries);
        } else {
            fail(RESPONSE_IS_NOT_READY);
        }
    }
    ...
    public void testShowEntries100() throws Exception {
        ...
        if (isReady) {
            ...
            final String EXPECTED_SHOW_ENTRIES_100 =
                    "one 4\n" + "ёлка 3\n" + "two 3\n" + "білка 3\n" + "объем 3\n" + "їжак 2\n" + "объём 1\n" + "ученики 1\n" +
                            "і 1\n" + "але 1\n" + "имя 1\n" + "слово 1\n" + "a 1\n" + "но 1\n" + "дом 1\n" + "друг 1\n" + "єнот 1\n" +
                            "время 1\n" + "та 1\n" + "the 1\n" + "человек 1\n" + "народ 1\n" + "r 1\n" + "завет 1\n" + "сказал 1";
            String actualShowEntries = driver.findElement(By.cssSelector(ANCHOR_HTML_PAGE_WITH_WORDS)).getText();
            assertEquals(EXPECTED_SHOW_ENTRIES_100, actualShowEntries);
        } else {
            fail(RESPONSE_IS_NOT_READY);
        }
    }
    ...
    public void testShowEntries10() throws Exception {
        ...
        // then
        if (isReady) {
            final String DATA_TABLES_LENGTH_10 = "10";
            new Select(driver.findElement(By.name(ELEMENT_DATA_TABLES_LENGTH))).selectByVisibleText(DATA_TABLES_LENGTH_100);
            new Select(driver.findElement(By.name(ELEMENT_DATA_TABLES_LENGTH))).selectByVisibleText(DATA_TABLES_LENGTH_10);
            String actualShowEntries = driver.findElement(By.cssSelector(ANCHOR_HTML_PAGE_WITH_WORDS)).getText();
            assertEquals(EXPECTED_STANDARD_RESULT, actualShowEntries);
        } else {
            fail(RESPONSE_IS_NOT_READY);
        }
    }
