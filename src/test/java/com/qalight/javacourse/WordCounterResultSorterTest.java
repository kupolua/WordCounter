...
//        Map<String, Integer> actualResultByKA = resultSorter.sortWords(hashMap, "KA");
//        Map<String, Integer> actualResultByKD = resultSorter.sortWords(hashMap, "KD");
//        Map<String, Integer> actualResultByVA = resultSorter.sortWords(hashMap, "VA");
//        Map<String, Integer> actualResultByVD = resultSorter.sortWords(hashMap, "VD");
//
//        //then
